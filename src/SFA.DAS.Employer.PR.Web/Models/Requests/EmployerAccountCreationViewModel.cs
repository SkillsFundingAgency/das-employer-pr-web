...
public class EmployerAccountCreationSubmitModel : EmployerAccountNamesModel
{
    public required bool HasAcceptedTerms { get; set; }
}

public class EmployerAccountNamesModel : EmployerAccountNamesSubmitModel
{
    public string? BackLink { get; set; }
}

public class EmployerAccountNamesSubmitModel
{
