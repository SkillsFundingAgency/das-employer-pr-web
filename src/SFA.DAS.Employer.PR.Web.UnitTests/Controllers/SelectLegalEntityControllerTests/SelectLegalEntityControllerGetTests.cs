...
public class SelectLegalEntityControllerGetTests
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        SelectLegalEntityController sut = new(Mock.Of<IOuterApiClient>(), sessionServiceMock.Object, Mock.Of<IValidator<SelectLegalEntitiesSubmitViewModel>>())
        {
    ...
    public async Task CallsSessionServiceGet(
